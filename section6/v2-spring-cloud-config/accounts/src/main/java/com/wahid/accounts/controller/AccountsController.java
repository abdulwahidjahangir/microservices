package com.wahid.accounts.controller;
...
import com.wahid.accounts.dto.ErrorResponseDto;
import com.wahid.accounts.dto.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs fro Accounts in Wahid Bank",
        description = "CRUD REST APIs fro Accounts in Wahid Bank to update, delete and fetch account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create account in Wahid Bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @Operation(
            ...
            description = "Get Java Version Details that is deployed into accounts microservices"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
